...
选择`touch-fish.jar/zip`,完成后重启IDEA,可以看到IDEA下方工具栏(与Terminal同一行)里多了个`Touch Fish`了.  
`touch-fish.jar`文件请到[https://github.com/sasayaku/touch-fish/releases](https://github.com/sasayaku/touch-fish/releases)下载最新版,也可以下载本项目后自行编译.
